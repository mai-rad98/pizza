...
<head>
  ...
  <title>PRIME PIZZA ONLINE ORDER</title>
  ...
  <body data-spy="scroll" data-target="#navbar-Menu">
    ...
    <nav class="navbar navbar-expand-lg navbar-expand-md navbar-dark fixed-top">
      <div class="container">
          <button id="modalBtn" class="button"><a class="navbar-brand"><img src="logo.png" class="img-responsive" style ="width:45px">&nbsp; UB PIZZARIA</a></button>
            ...
            <hr>
						...
						<?php
							...
							//	echo "<p> <strong>".$_SESSION['ordertype']." for ".$_SESSION['ordertime']."</strong></p> <hr>";
								...
								echo "<p><strong>Sub Total: </strong>P".round($_SESSION['total_price'],2)."</br><p>";
								echo "<p><strong>Tax: </strong>P".round($_SESSION['tax'],2)."</br><p>";
								$_SESSION['total_price']=$_SESSION['tax']+$_SESSION['total_price'];
								echo "<p><strong>TOTAL PRICE: </strong>P".round($_SESSION['total_price'],2)."</br><p>";
							}
						?>
					</div>
