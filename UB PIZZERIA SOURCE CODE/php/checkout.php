...
<html lang="en" dir="ltr">
  ...
  <body>
    ...
    <nav class="navbar navbar-expand-lg navbar-expand-md navbar-dark fixed-top">
      <div class="container">
          <a href="#" class="navbar-brand"><img src="logo.png" class="img-responsive" style ="width:45px">UB PIZZARIA</a>
                  ...
                  <div class="container">
                    ...
                    <?php
            						...
            						//	echo "<p> <strong>".$_SESSION['ordertype']." for ".$_SESSION['ordertime']."</strong></p> <hr>";
            							...
            							echo "<p><strong>TOTAL PRICE: <span class='price' style='color:black'></strong>P".round($_SESSION['final_price'],2)."</br></span><p>";
            						}
            			?>
                  </div>
                </div>
